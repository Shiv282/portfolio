          ...
          <div class="card-container my-5 flex flex-row">
            <div className="education mx-5 w-full">
              ...
              <div className="card flex flex-col mt-3 rounded-lg bg-gray-100 px-2 py-2">
                ...
                <span className="mx-5 text-xl text-slate-900">CGPA - 8.3</span>
              </div>
              ...
              <div className="card flex flex-col mt-3 rounded-lg bg-gray-100 px-2 py-2">
                ...
                <span className="mx-5 text-xl text-slate-900">90.5%</span>
              </div>
              ...
              <div className="card flex flex-col mt-3 rounded-lg bg-gray-100 px-2 py-2">
                ...
                <span className="mx-5 text-xl text-slate-900">92.8%</span>
              </div>
            </div>
            ...
            <div className="experience mx-5 w-full">
              ...
              <div className="card mt-3 rounded-lg bg-gray-100 px-2 py-2">
                <div className="flex flex-row">
                  <svg
                    stroke="black"
                    fill="black"
                  ...
                  <span className="ml-5 text-xl font-bold text-slate-900">
                    Full stack web development
                  </span>
                </div>
              </div>

              <div className="card my-2 rounded-lg bg-gray-100 px-2 py-2">
                <div className="flex flex-row">
                  <svg
                    stroke="black"
                    fill="black"
